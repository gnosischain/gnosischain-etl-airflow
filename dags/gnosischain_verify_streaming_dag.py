...
from gnosischainetl_airflow.build_verify_streaming_dag import build_verify_streaming_dag
from gnosischainetl_airflow.variables import read_verify_streaming_dag_vars
...
DAG = build_verify_streaming_dag(
    dag_id='gnosischain_verify_streaming_dag',
