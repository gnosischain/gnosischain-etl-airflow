...
def build_load_dag(
    ...
    def add_enrich_tasks(task, time_partitioning_field='block_timestamp', dependencies=None, always_load_all_partitions=False):
        def enrich_task(ds, bigquery_location='EU', **kwargs):
            ...
            query_job = client.query(sql, location=bigquery_location, job_config=query_job_config)
            ...
            if load_all_partitions or always_load_all_partitions:
                ...
                copy_job = client.copy_table(temp_table_ref, dest_table_ref, location=bigquery_location, job_config=copy_job_config)
                ...
                print('Merge sql:')
                print(merge_sql)
                merge_job = client.query(merge_sql, location=bigquery_location, job_config=merge_job_config)
